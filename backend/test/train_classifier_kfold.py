...
def preprocess_fold_data(features_train, labels_train, features_val):
    ...
    # Augment with noise
    augmented_features_list = [features_train_scaled]
    ...
    features_train_res, labels_train_res = smote.fit_resample(
...
if __name__ == "__main__":
    ...
    # ## K-FOLD: Create the outer 80/20 train_val/test split
    ...
    # ## K-FOLD: Start the K-Fold Validation loop
